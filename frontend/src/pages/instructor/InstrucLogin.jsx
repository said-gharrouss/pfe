...
import { INSTRUCTOR_DASHBOARD_ROUTE} from "../../router/Index";
import { zodResolver } from "@hookform/resolvers/zod";
import { useForm } from "react-hook-form";
import { z } from "zod";
import { useUserContext } from "../../context/UserContext";

function InstrucLogin() {
        ...
        .then( ({status,data}) => {
            if(status === 200){
                ...
                switch (role) {
                    case "student" :
                        setError("email", {
                            message: "Veuillez vous connecter avec le formulaire de connexion stagiaire si vous êtes stagiaire !!"
                        });
                    ...
                    case "admin" :
                        ...
                        break;
                    case "instructor" :
                        navigate(INSTRUCTOR_DASHBOARD_ROUTE);
                        break;
                }
            }
        }
    ...
    return (
        ...
        border-[1px] border-secondary mx-auto mt-[100px] relative">
            <p className="text-[25px] font-bold text-center mb-[20px]">Bienvenue de retour, Enseignant(e)</p>
